...
<body>
  ...
  <section id="section1" class="section-2 text-center">
    <div class="container">
      <h1><a class="nav-link text-secondary" href="https://www.google.co.id/maps/place/Nasmoco+Pemuda/@-6.9748036,110.4170371,17z/data=!3m1!4b1!4m5!3m4!1s0x2e70f4acba9c35cf:0x10935c3ee70d27f3!8m2!3d-6.9748089!4d110.4192258">Nasmoco Pemuda</a></h1>
      Jl. Pemuda No.72, Pandansari, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50133
      <br>
      <br>
      <div class="row">
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Antri</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Antri' AND cbg = 'Pemuda'");
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Servis</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Servis' AND cbg = 'Pemuda'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Booking</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Booking' AND cbg = 'Pemuda'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
