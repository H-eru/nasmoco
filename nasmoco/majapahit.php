...
<body>
  ...
  <section id="section1" class="section-2 text-center">
    <div class="container">
      <h1><a class="nav-link text-secondary" href="https://www.google.co.id/maps/place/Nasmoco+Majapahit/@-7.0136905,110.4792901,17z/data=!4m8!1m2!2m1!1snasmoco+majapahit!3m4!1s0x2e708cfeed00940d:0x44d5526f6e1a63a3!8m2!3d-7.0136905!4d110.4814788">Nasmoco Majapahit</a></h1>
      Jl. Brigjen Sudiarto No. 426, Pedurungan (Majapahit), Semarang 50199
      <br>
      <br>
      <div class="row">
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Antri</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Antri' AND cbg = 'Majapahit'");
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Servis</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Servis' AND cbg = 'Majapahit'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Booking</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Booking' AND cbg = 'Majapahit'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
