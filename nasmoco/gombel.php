...
<body>
  ...
  <section id="section1" class="section-2 text-center">
    <div class="container">
      <h1><a class="nav-link text-secondary" href="https://www.google.co.id/maps/place/Nasmoco+Gombel+Semarang/@-7.0434517,110.4197484,17z/data=!3m1!4b1!4m5!3m4!1s0x2dd7f96041613647:0xe47cc4e68ec9ee7b!8m2!3d-7.043457!4d110.4219371">Nasmoco Gombel</a></h1>
      Jl. Setia Budi No.22, Ngesrep, Kec. Banyumanik, Kota Semarang, Jawa Tengah 50269
      <br>
      <br>
      <div class="row">
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Antri</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Antri' AND cbg = 'Gombel'");
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Servis</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Servis' AND cbg = 'Gombel'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Booking</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Booking' AND cbg = 'Gombel'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
