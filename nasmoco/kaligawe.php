...
<body>
  ...
  <section id="section1" class="section-2 text-center">
    <div class="container">
      <h1><a class="nav-link text-secondary" href="https://www.google.co.id/maps/place/Nasmoco+Kaligawe/@-6.9553545,110.4623948,17z/data=!3m1!4b1!4m5!3m4!1s0x2dd7f93ea4374961:0x8663e59b191c8b23!8m2!3d-6.9553598!4d110.4645835">Nasmoco Kaligawe</a></h1>
      jalan Raya Kaligawe KM.5, Terboyo Wetan, Kec. Genuk, Kota Semarang, Jawa Tengah 50112
      <br>
      <br>
      <div class="row">
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Antri</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Antri' AND cbg = 'Kaligawe'");
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Servis</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Servis' AND cbg = 'Kaligawe'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Booking</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Booking' AND cbg = 'Kaligawe'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
