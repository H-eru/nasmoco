...
<head>
  ...
  <title>Nasmoco - Cabang Service</title>
</head>
...
<body>
  ...
  <section id="section1" class="section-2 text-center">
    <div class="container">
      <h1><a class="nav-link text-secondary" href="https://www.google.co.id/maps/place/Toyota+Semarang+Nasmoco+Siliwangi/@-6.9833138,110.3856336,17z/data=!4m5!3m4!1s0x2e708b2ef4b52a7b:0x8dafd39e53201aeb!8m2!3d-6.9835534!4d110.3871464">Nasmoco Siliwangi</a></h1>
      Jl. Jenderal Sudirman No.291, Gisikdrono, West Semarang, Semarang City, Central Java 50149
      <br>
      <br>
      <div class="row">
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Antri</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Antri' AND cbg = 'Siliwangi'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center"><?php echo $antrian; ?></h1>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Servis</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Servis' AND cbg = 'Siliwangi'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-12 box-1">
          <div class="row box" data-aos="fade-left" data-aos-delay="300">
            ...
            <div class="col-lg-10 col-sm-12">
              <h1><a>Booking</a></h1>
              <?php
              $query = mysqli_query($conn, "SELECT * FROM service WHERE status='Booking' AND cbg = 'Siliwangi'");
              $antrian = mysqli_num_rows($query);
              ?>
              <h1 class="text-center "><?php echo $antrian; ?></h1>
            </div>
